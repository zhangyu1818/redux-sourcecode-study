 ...
 */
  // 判断类型
  // 如果使用了增强器返回 State & Extension 否则返回 State
 ...
 *
 * store增强器是一个高阶函数，它接收store creator返回一个新的store creator
 *
 ...
 *
 * store enhancer和react里的高阶组件非常像，偶尔也会叫它“component enhancers”.
 *
 ...
 * demonstrating that.
 *
 * 因为store不是一个实例，而是一个函数创建出的普通对象集合，所以复制对象就可以轻松的修改store
 *
